...
var Alert = /*#__PURE__*/function () {
  ...
  _createClass(Alert, [{
    ...
    value: function showMessage() {
      ...
      alert.className = "alert alert--".concat(this.type);
      alert.innerHTML = "<img class=\"alert__icon ".concat(this.type == 'error' ? 'alert__icon--error' : '', "\" ").concat(this.type == 'error' ? 'src="/img/ui/close.svg" alt="error"' : this.type === 'success' ? 'src="/img/ui/tick.svg" alt="success"' : '', "><p class=\"alert__message\">").concat(this.message, "</p>");
...
var removeBeforeUnload = function removeBeforeUnload() {
...
},{"./Components/Alert":"Components/Alert.js"}],"Components/AuthForm.js":[function(require,module,exports) {
"use strict";
...
var AuthForm = /*#__PURE__*/function (_HTMLFormElement) {
  _inherits(AuthForm, _HTMLFormElement);
  ...
  function AuthForm() {
    ...
    _this.button = _this.querySelector('.form__button--send');
    _this.inputs = _this.querySelectorAll('.form__input');

    _this.inputs.forEach(function (input) {
      _this.handleLabels.call(input);

      input.addEventListener('input', _this.handleLabels);
      input.addEventListener('focusin', function () {
        input.classList.add('form__input--float-label');
      });
      input.addEventListener('focusout', _this.handleLabels);
    });
  ...
  _createClass(AuthForm, [{
    ...
    value: function () {
      ...
      function collectBodyAndSend(_x, _x2, _x3) {
        return _collectBodyAndSend.apply(this, arguments);
      }

      return collectBodyAndSend;
    }()
  }, {
    key: "sendAsync",
    value: function () {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 7:
                ...
                return _context2.abrupt("return", new _Alert.Alert('error', resData.message).showMessage());

              case 11:
                new _Alert.Alert('success', successMessage).showMessage();
              ...
              case 15:
                ...
                new _Alert.Alert('error', _context2.t0).showMessage();
      ...
      function sendAsync(_x4, _x5, _x6) {
    ...
    key: "stopSpinner",
    value: function stopSpinner(buttonText) {
      this.button.innerHTML = buttonText;
    }
  }]);

  return AuthForm;
}( /*#__PURE__*/_wrapNativeSuper(HTMLFormElement)); // class LoginForm extends AuthForm {
//   constructor() {
//     super();
//   }
//   connectedCallback() {
...
},{"./Alert":"Components/Alert.js"}],"Components/Multiselect.js":[function(require,module,exports) {
"use strict";
...
},{}],"Components/Checkbox.js":[function(require,module,exports) {
"use strict";
...
},{}],"Components/NestedTable.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.NestedTableFactory = void 0;
...
var NestedTable = /*#__PURE__*/function () {
  function NestedTable(element) {
    var _this = this;
    ...
    this.trs = this.element.querySelectorAll('.list__row--form:not(.list__row--heading)');
    this.addNewBtn = this.element.querySelector('button');
    this.inputs = this.element.querySelectorAll('input[type="text"], textarea, .checkbox');
    this.values = [];
    this.init();
    console.log(this.values);
    this.inputs.forEach(function (input) {
      return input.addEventListener('input', _this.handleInput.bind(_this));
    });
  ...
  _createClass(NestedTable, [{
    ...
    value: function init() {
      var vals = [];
      this.trs.forEach(function (row) {
        var inputs = row.querySelectorAll('input[type="text"], textarea, .checkbox');
        var obj = {};
    ...
    value: function handleInput(e) {
      ...
      var index = _toConsumableArray(this.trs).indexOf(tr);

      this.values[index][input.dataset.key] = input.getAttribute('role') == 'checkbox' ? input.getAttribute('aria-checked') == 'true' : input.value;
      console.log(this.values);
      this.input.value = JSON.stringify(this.values);
    } // 
...
var AcceptanceCriteriaTable = /*#__PURE__*/function (_NestedTable) {
  _inherits(AcceptanceCriteriaTable, _NestedTable);

  var _super = _createSuper(AcceptanceCriteriaTable);

  function AcceptanceCriteriaTable(element) {
    _classCallCheck(this, AcceptanceCriteriaTable);

    return _super.call(this, element);
  }

  _createClass(AcceptanceCriteriaTable, [{
    key: "addRow",
    value: function addRow() {
      var _this2 = this;
      ...
      var deleteBtn = tr.querySelector('button');
      var inputs = tr.querySelectorAll('input[type="text"], textarea, .checkbox');
      deleteBtn.addEventListener('click', function () {
        _this2.values.pop();

        _this2.tbody.removeChild(tr);

        _this2.updateThis();

        console.log(_this2.values);
        _this2.input.value = JSON.stringify(_this2.values);
      });
      inputs.forEach(function (input) {
        if (input.classList.contains('checkbox')) {
          new _Checkbox.Checkbox(input);
        }

        input.addEventListener('input', function (e) {
          _this2.handleInput.bind(_this2)(e);
        });
      });
      console.log(this.values);
      this.updateThis();
  ...
  return AcceptanceCriteriaTable;
}(NestedTable);

var NestedTableFactory = /*#__PURE__*/function () {
  function NestedTableFactory() {
    _classCallCheck(this, NestedTableFactory);
  }

  _createClass(NestedTableFactory, null, [{
    key: "create",
    value: function create(T, element) {
      return new this.dictionary[T](element);
    }
  ...
  return NestedTableFactory;
}();

exports.NestedTableFactory = NestedTableFactory;

_defineProperty(NestedTableFactory, "dictionary", {
  AcceptanceCriteriaTable: AcceptanceCriteriaTable
});
},{"./Checkbox":"Components/Checkbox.js"}],"Components/TabbedInterface.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.TabbedInterface = void 0;
...
var TabbedInterface = /*#__PURE__*/function () {
  function TabbedInterface(element) {
    var _this = this;

    _classCallCheck(this, TabbedInterface);
  ...
  _createClass(TabbedInterface, [{
    key: "init",
    value: function init() {
      this.tabList.setAttribute('role', 'tablist');
      this.tabList.setAttribute('aria-orientation', 'vertical');
      this.tabButtons.forEach(function (tab, index) {
        if (index == 0) {
          tab.classList.add('tabs__tab--active');
        }

        tab.setAttribute('role', 'tab');
        tab.setAttribute('aria-controls', "panel_".concat(index));
        tab.id = "tab_".concat(index);
      });
      this.tabPanels.forEach(function (panel, index) {
        ...
        panel.setAttribute('aria-labelledby', "tab_".concat(index));
        panel.id = "panel_".concat(index);
      });
    }
  }, {
    key: "handleClick",
    value: function handleClick(e) {
      ...
      var index = _toConsumableArray(this.tabButtons).indexOf(button);
    ...
    set: function set(val) {
      var oldActivePanel = this.tabPanels[this.active];
      var oldActiveButton = this.tabButtons[this.active];
      var newActivePanel = this.tabPanels[val];
      var newActiveButton = this.tabButtons[val]; // Change oldActive selected to false

      oldActivePanel.setAttribute('aria-selected', false);
      oldActivePanel.classList.remove('tabs__tabpanel--active');
      oldActiveButton.classList.remove('tabs__tab--active'); // Change newActive selected to true
...
},{}],"Components/DataTable.js":[function(require,module,exports) {
"use strict";
...
var DataTable = /*#__PURE__*/function () {
  function DataTable(element) {
    ...
    this.cells = [].concat(_toConsumableArray(this.ths), _toConsumableArray(this.tds));
    this.anchors = this.table.querySelectorAll('a');
    this.dataSearch = document.querySelector("input[aria-controls=\"".concat(this.table.id, "\"]"));
    this.initAria();
    ...
    this.cells.forEach(function (cell) {
      return cell.addEventListener('click', _this.handleClick.bind(_this));
    });
    this.cells.forEach(function (cell) {
      return cell.addEventListener('keydown', _this.handleKeyDown.bind(_this));
    });
  }
  ...
  _createClass(DataTable, [{
    ...
    value: function initAria() {
      ...
      this.trs.forEach(function (tr) {
        return tr.setAttribute('role', 'row');
      });
      this.ths.forEach(function (th, index) {
      ...
      this.tds.forEach(function (td, index) {
        td.setAttribute('role', 'gridcell');
        td.setAttribute('tabindex', -1);
        td.setAttribute('aria-rowindex', Math.ceil((index + 1) / _this2.ths.length) + 1);
        td.setAttribute('aria-colindex', index % _this2.ths.length + 1);
      });
    ...
    value: function handleClick(e) {
      ...
      var idx = _toConsumableArray(this.cells).indexOf(tar);
    ...
    key: "handleKeyDown",
    value: function handleKeyDown(e) {
      var colsNum = this.ths.length;
      var cellsNum = this.cells.length;
      ...
      switch (e.keyCode) {
        ...
        case 37:
          {
            e.preventDefault();
            if (this.selected % colsNum == 0) return;else this.selected--;
            break;
          }
        ...
        case 38:
          {
            e.preventDefault();
            if (this.selected < colsNum) return;else this.selected = this.selected - colsNum;
            break;
          }
        ...
        case 39:
          {
            e.preventDefault();
            if (this.selected % colsNum == colsNum - 1) return;else this.selected++;
            break;
          }
        ...
        case 40:
          {
            e.preventDefault();
            if (this.selected > cellsNum - colsNum - 1) return;else this.selected = this.selected + colsNum;
            break;
          }
        // Space, enter
        ...
        case 32:
          {
            e.preventDefault();
            var tar = e.target.closest('tr > *');
            var anchor = tar.querySelector('a');
    ...
    key: "openLink",
    value: function openLink(anchor) {
      var href = anchor.getAttribute('href');
      if (!href) return;
      return window.location.assign("".concat(window.location.protocol).concat(href.startsWith('/') ? href : '/' + href));
    }
  }, {
    key: "handleSort",
    value: function handleSort(e) {
      console.log(e.target);
      var val = e.target.closest('th').dataset.sortval;
      console.log(val);
      var link = this.updateURLSortParameter("".concat(window.location.href), val);
      location.assign("".concat(link));
    }
  }, {
    key: "handleSearch",
    ...
    key: "updateURLSortParameter",
    value: function updateURLSortParameter(url, paramVal, param) {
      var newAddURL = '',
          sortVals;
      var urlParts = url.split('?');
      var baseURL = urlParts[0];
      var additionalURL = urlParts[1];

      if (additionalURL) {
        var queryParts = additionalURL.split('&'); // ["grid=true", "sort=description,name"]

        var sortQuery = queryParts.splice(queryParts.findIndex(function (part) {
          return part.startsWith('sort');
        }), 1);
        console.log('query prts: ', queryParts);
        console.log('sortquer: ', sortQuery);

        if (sortQuery[0]) {
          var sortStringValue = sortQuery[0].split('=')[1];
          console.log('sortStringVal', sortStringValue);
          sortVals = sortStringValue.split(',');
          console.log('sortVals', sortVals);
          var regex = new RegExp(paramVal, 'g');
          var editedSortValue = sortVals.find(function (val) {
          ...
          if (!editedSortValue) {
            ...
            if (editedSortValue.startsWith('-')) {
              ...
              console.log('we are here when its description');
              sortVals[sortVals.indexOf(editedSortValue)] = "-".concat(paramVal);
            }
          }
        } else {
          sortVals.push(paramVal);
        ...
        newAddURL = "?".concat(queryParts.concat("".concat(sortVals.length > 0 ? 'sort=' : '').concat(sortVals.join(','))).join('&'));
      } else {
        newAddURL = "?sort=".concat(paramVal);
      }
    ...
    key: "addSortingIcons",
    value: function addSortingIcons() {
      var _this3 = this;

      var queryString = location.search.slice(1);
      var queryArr = queryString.split('&');
      var sortQuery = queryArr.find(function (query) {
        return query.startsWith('sort');
      });
      if (!sortQuery) return;
      var sortString = sortQuery.split('=')[1];
      var sortArr = sortString.split(',');
      sortArr.forEach(function (val, index) {
        var th, order;
        ...
        th = _this3.table.querySelector("[data-sortval=\"".concat(val, "\"]"));
        if (!th) return;
        var span = th.firstChild;
        var text = span.textContent;
        var icon = order === 'desc' ? "<img class=\"datatable-icon\" src=\"/img/ui/sort-down.svg\" alt=\"sort down\">" : "<img class=\"datatable-icon\" src=\"/img/ui/sort-ascending.svg\" alt=\"sort up\">";
        span.innerHTML = "".concat(text, "\n      ").concat(icon, "\n      <span class=\"datatable-sort-order\">").concat(index + 1, "</span>");
      });
    }
  }, {
    key: "selected",
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("".concat(window.location.protocol, "/api/v1/users/logout"), {
              method: 'GET'
            });
          ...
          case 11:
            _context.prev = 11;
            _context.t0 = _context["catch"](0);
            new _Alert.Alert('error', 'Error logging out').showMessage();
...
},{"./Components/Alert.js":"Components/Alert.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _NestedTable = require("./Components/NestedTable");

var _Checkbox = require("./Components/Checkbox");

var _TabbedInterface = require("./Components/TabbedInterface");
...
// Components
var multiSelects = document.querySelectorAll('.multiselect--user');
...
var tabsMe = document.querySelector('.tabs');
var dataTables = document.querySelectorAll('.list'); // form templates

var formTemplates = document.querySelectorAll('.form-template'); // auth forms

var loginForm = document.querySelector('.form__body--login');
var signupForm = document.querySelector('.form__body--signup');
var resetPasswordForm = document.querySelector('.form__body--reset-password');
var forgotPasswordForm = document.querySelector('.form__body--forgot-password');
var updateMeForm = document.querySelector('.form__body--update-me');
var updatePasswordForm = document.querySelector('.form__body--update-password');
...
if (checkboxes.length > 0) {
  checkboxes.forEach(function (checkbox) {
    new _Checkbox.Checkbox(checkbox);
  });
}

if (acTables.length > 0) {
  acTables.forEach(function (table) {
    _NestedTable.NestedTableFactory.create('AcceptanceCriteriaTable', table);
  });
}
...
if (tabsMe) {
  new _TabbedInterface.TabbedInterface(tabsMe);
}
...
if (dataTables.length > 0) {
  ...
  dataTables.forEach(function (table) {
    console.log(table);
    var dataTable = new _DataTable.DataTable(table);
  });
}

if (formTemplates.length > 0) {
  formTemplates.forEach(function (template) {
    new _FormTemplate.FormTemplate(template);
  });
}
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    this.collectBodyAndSend({
      endpoint: "".concat(window.location.protocol, "/api/v1/users/login"),
      method: 'POST'
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    e.preventDefault();
    this.collectBodyAndSend({
      endpoint: "".concat(window.location.protocol, "/api/v1/users/signup"),
      method: 'POST',
      runSpinner: true
    }, 'Success, please confirm your email address');
  });
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    this.collectBodyAndSend({
      endpoint: "".concat(window.location.protocol, "/api/v1/users/forgotPassword"),
      method: 'POST',
      runSpinner: true
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    this.collectBodyAndSend({
      endpoint: "".concat(window.location.protocol, "/api/v1/users/resetPassword/").concat(resetPasswordForm.dataset.token),
      method: 'PATCH'
    }, 'Password reset successfully', function () {
      return setTimeout(function () {
        return location.assign('/');
      }, 2000);
    });
...
if (updateMeForm) {
  updateMeForm.addEventListener('submit', function (e) {
    e.preventDefault();
    this.collectBodyAndSend({
      endpoint: "".concat(window.location.protocol, "/api/v1/users/updateDetails"),
      method: 'PATCH'
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    this.collectBodyAndSend({
      endpoint: "".concat(window.location.protocol, "/api/v1/users/updatePassword"),
      method: 'PATCH'
